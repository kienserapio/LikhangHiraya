    ...
    return (
      <div className="product-page">
        <main className="product-main" style={{ padding: 24 }}>
          ...
          <button className="product-add-btn" onClick={() => navigate("/home")} type="button">
      ...
      <main className="product-main">
        <section className={`hero ${isOutOfStock ? "hero-out-of-stock" : ""}`} data-purpose="product-hero">
          ...
          <div className="hero-top">
            <button aria-label="Go back" className="icon-btn back-btn" onClick={() => navigate(-1)} type="button">
